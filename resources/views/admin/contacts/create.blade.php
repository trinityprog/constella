...
@section('content_header')
    ...
    <h1 class="text-center mb-4">Добавить город</h1>
@stop
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.contacts.store') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
