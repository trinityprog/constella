<div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="title" type="text" id="title" value="{!! old('title'), $menu->title ?? '' !!}" >
    {!! $errors->first('title', '<p class="help-block">:message</p>') !!}
</div>

<div class="form-group {{ $errors->has('seo_description') ? 'has-error' : ''}}">
    <label for="seo_description" class="control-label">{{ 'Описание' }}</label>
    <input class="form-control" name="seo_description" type="text" id="seo_description" value="{!! old('seo_description'), $menu->seo_description ?? '' !!}" >
...
<div class="form-group {{ $errors->has('H1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="H1" type="text" id="H1" value="{!! old('H1'), $menu->H1 ?? '' !!}" >
...
<div class="form-group {{ $errors->has('H2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="H2" type="text" id="H2" value="{!! old('H2'), $menu->H2 ?? '' !!}" >
...
<div class="form-group {{ $errors->has('H3') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="H3" type="text" id="H3" value="{!! old('H3'), $menu->H3 ?? '' !!}" >
...
<div class="form-group {{ $errors->has('H4') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="H4" type="text" id="H4" value="{!! old('H4'), $menu->H4 ?? '' !!}" >
...
<div class="form-group {{ $errors->has('H5') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="H5" type="text" id="H5" value="{!! old('H5'), $menu->H5 ?? '' !!}" >
...
<div class="form-group {{ $errors->has('H6') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="H6" type="text" id="H6" value="{!! old('H6'), $menu->H6 ?? '' !!}" >
...
<div class="form-group {{ $errors->has('H1_seo_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="H1_seo_text" type="text" id="H1_seo_text" value="{!! old('H1_seo_text'), $menu->H1_seo_text ?? '' !!}" >
...
<div class="form-group {{ $errors->has('H2_seo_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="H2_seo_text" type="text" id="H2_seo_text" value="{!! old('H2_seo_text'), $menu->H2_seo_text ?? '' !!}" >
...
<div class="form-group {{ $errors->has('H3_seo_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="H3_seo_text" type="text" id="H3_seo_text" value="{!! old('H3_seo_text'), $menu->H3_seo_text ?? '' !!}" >
...
<div class="form-group {{ $errors->has('H4_seo_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="H4_seo_text" type="text" id="H4_seo_text" value="{!! old('H4_seo_text'), $menu->H4_seo_text ?? '' !!}" >
...
<div class="form-group {{ $errors->has('H5_seo_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="H5_seo_text" type="text" id="H5_seo_text" value="{!! old('H5_seo_text'), $menu->H5_seo_text ?? '' !!}" >
...
<div class="form-group {{ $errors->has('H6_seo_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="H6_seo_text" type="text" id="H6_seo_text" value="{!! old('H6_seo_text'), $menu->H6_seo_text ?? '' !!}" >
...
<div class="form-group {{ $errors->has('keywords') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="keywords" type="text" id="keywords" value="{!! old('keywords'), $menu->keywords ?? '' !!}" >
