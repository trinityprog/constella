            ...
            <div class="card-header">
               <h3 class="card-title pt-2">Users</h3>
                 <div class="card-tools">
                    <a href="{{ url('/admin/users/create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Создать</a>
                 </div>
            </div>
            ...
            <div class="card-body table-responsive table-striped p-0">
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th>#</th><th>Name</th><th>Email</th><th>Sex</th><th class="text-right">Действия</th>
                            </tr>
                        </thead>
                        <tbody>
                        @foreach($users as $item)
                            <tr>
                                ...
                                <td>{{ $item->name }}</td><td>{{ $item->email }}</td><td>{{ $item->sex }}</td>
                                <td class="text-right">
