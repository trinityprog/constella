            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.career_category.store') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            @include ('admin.career.form', ['formMode' => 'create'])
                        </form>
                    </div>
                </div>
            </div>
