...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header">
               <h3 class="card-title pt-2">Zhannas</h3>
                 <div class="card-tools">
                    <a href="{{ url('/admin/zhannas/create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Создать</a>
                 </div>
            </div>
            ...
            <div class="card-body table-responsive table-striped p-0">
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th>#</th><th>Product Id</th><th>Category Id</th><th class="text-right">Действия</th>
                            </tr>
                        </thead>
                        <tbody>
                        @foreach($zhannas as $item)
                            <tr>
                                ...
                                <td>{{ $item->product_id }}</td><td>{{ $item->category_id }}</td>
                                <td class="text-right">
                    ...
                    <div class="pagination-wrapper"> {!! $zhannas->appends(['search' => Request::get('search')])->render() !!} </div>
                </div>
