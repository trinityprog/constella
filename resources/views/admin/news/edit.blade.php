...
@section('content_header')
    ...
    <h1 class="text-center mb-4">Изменить событие #{{ $news->id }}</h1>
@stop
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.news.update', $news->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                        {{ method_field('PATCH') }}
                        {{ csrf_field() }}
